<!-- Content Header (Page header) -->
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h2 style="color: green;" class="box-title"><i class="fa fa-users"></i><?= __(' Insert User');?></h2>
                <div class="box-tools pull-right">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        echo $this->Form->input(__('password'), ['class' => 'form-control', 'placeholder' => 'Digite senha . . .']);
                        ?>
